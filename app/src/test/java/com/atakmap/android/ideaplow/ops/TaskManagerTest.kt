...
class TaskManagerTest {
    ...
    private fun task(uid: String = "ideaplow-task-SUP-1-1000", timeMs: Long = 1000L) = TaskEvent(
        uid = uid,
    ...
    fun `create ack workflow broadcasts transitions`() {
        ...
        assertEquals(1, mgr.pendingFor("IDEAPLOW-T-1").size)
        ...
        assertTrue(mgr.pendingFor("IDEAPLOW-T-1").isEmpty())
    }
