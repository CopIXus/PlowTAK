 ...
 * children. All IdeaPlow detail building/parsing happens against this type so
...
data class DetailNode(
    ...
    companion object {
        /** The IdeaPlow detail namespace element inside CoT `<detail>`. */
        const val IDEAPLOW = "__ideaplow"
    }
}
