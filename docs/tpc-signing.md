...
**Successful TPP job:** `amos-halava1-leo-gov-20260816-014839`  
  (APK `PlowTAK-26.0816.0149-ATAK-5.8.0-civ-release.apk`)  
**GitHub release:** https://github.com/CopIXus/PlowTAK/releases/tag/tpc-0.1.9  
**Git commit:** `639558e` (storm pills / PLI / HUD reports + HUD dp fix)
